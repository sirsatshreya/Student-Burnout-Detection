...
function applyFilters() {
    ...
    const filtered = checkins.filter(function (item) {
...
function burnoutRisk(item) {
    ...
    if (Number(item.sleep || 0) < 6) {
        score += 20;
    }

    score += (10 - Number(item.motivation || 0)) * 4;

    if (Number(item.study || 0) > 10) {
        score += 10;
    }
...
function displayHistory(data) {
    ...
    data.forEach(function (item) {
        ...
        const index = checkins.findIndex(function (record) {
        ...
        rows += `
            <tr>
                ...
                <td>${item.stress || 0}/10</td>

                <td>${item.sleep || 0} hrs</td>

                <td>${item.study || 0} hrs</td>

                <td>${item.motivation || 0}/10</td>
...
}cument.getElementById("filterMood");
